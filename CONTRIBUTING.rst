...
Liquimigrate could always use more documentation, whether as part of the
official Liquimigrate docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
3. The pull request should work for Python 2.6, 2.7, 3.3, and 3.4, and for PyPy. Check
   https://travis-ci.org/onjin/liquimigrate/pull_requests
